...
{
    [SerializeField] protected float padLeft, padRight, padTop, padBottom;

    public float PadLeft { get { return padLeft; } set { SetProperty(ref padLeft, value); } }
    public float PadRight { get { return padRight; } set { SetProperty(ref padRight, value); } }
    public float PadTop { get { return padTop; } set { SetProperty(ref padTop, value); } }
    public float PadBottom { get { return padBottom; } set { SetProperty(ref padBottom, value); } }
    public float PadHorizontal { get { return PadLeft + PadRight; } }
    public float PadVertical { get { return PadTop + PadBottom; } }
    ...
    {
        float requiredSpace = requiredSpaceWithoutPadding + (axis == 0 ? PadHorizontal : PadVertical);
        float availableSpace = rectTransform.rect.size[axis];
        float surplusSpace = availableSpace - requiredSpace;
        float alignmentOnAxis = GetAlignmentOnAxis(axis);
        return (axis == 0 ? PadLeft : PadTop) + surplusSpace * alignmentOnAxis;
    }
